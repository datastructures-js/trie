...
describe("Trie unit tests", () => {
  ...
  describe(".hasPrefix(prefix)", () => {
    it("returns true for existing prefixes", () => {
      expect(trie.hasPrefix("h")).to.equal(true);
      expect(trie.hasPrefix("hel")).to.equal(true);
      expect(trie.hasPrefix("hi")).to.equal(true);
      expect(trie.hasPrefix("hid")).to.equal(true);
      expect(trie.hasPrefix("nam")).to.equal(true);
      expect(trie.hasPrefix("no")).to.equal(true);
      expect(trie.hasPrefix("sa")).to.equal(true);
      expect(trie.hasPrefix("saf")).to.equal(true);
    });

    it("returns false for none existing prefixes", () => {
      expect(trie.hasPrefix()).to.equal(false);
      expect(trie.hasPrefix(null)).to.equal(false);
      expect(trie.hasPrefix("ab")).to.equal(false);
      expect(trie.hasPrefix("helo")).to.equal(false);
      expect(trie.hasPrefix("hitt")).to.equal(false);
      expect(trie.hasPrefix("nnnn")).to.equal(false);
      expect(trie.hasPrefix("sandy")).to.equal(false);
      expect(trie.hasPrefix(123)).to.equal(false);
    });
  });
